...
FocusScope {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            InfoRectangle {
                                ...
                                currentMovie.extra["codec"].toUpperCase() : "N/A"
                            }
                            ...
                            InfoRectangle {
                                ...
                                currentMovie.extra["audio"].toUpperCase() : "N/A"
                            }
                        }
                    }
                }
    ...
    /*Rectangle{
        ...
        // Contenedor principal para los detalles - ESTE SIGUE CENTRADO
        Item {
            id: itemContainer
            ...
            // Contenedor para centrar el Row sin usar anchors dentro del Row
            Item {
                id: rowWrapper
                width: parent.width
                height: parent.height
                ...
                anchors {
                    ...
                    left: parent.left
                    leftMargin: parent.width * 0.1  // Ajusta este valor para mover más o menos a la derecha
                }
                ...
                Row {
                    ...
                    Item {
                        ...
                        FocusScope {
                            ...
                            height: btnLaunch.height + btnFavorite.height + btnPlayTrailer.height + 24 // Altura de todos los botones + spacing
                            focus: movieDetailsRoot.focus

                            // Propiedad para el índice del botón actualmente seleccionado
                            property int currentIndex: 0

                            // Botones en columna con navegación por teclado
                            Column {
                                id: buttonsLayout
                                width: parent.width
                                spacing: 12
                                ...
                                Rectangle {
                                    ...
                                    width: parent.width
                                    height: 46
                                    color: btnLaunch.activeFocus ? "#006dc7" : "#022441"  // Cambia color cuando tiene foco
                                    radius: 6
                                    border.width: btnLaunch.activeFocus ? 2 : 0
                                    border.color: "white"
                                    focus: true  // Este botón tiene el foco inicial
                    ...
                    Column {
                        ...
                        // Título de la película - Con null check
                        Text {
